...
subplot(3,5,1),plot(s); %relacion de posicion de la grafica%
title ('Grabacion 1')
subplot(3,5,2),plot(voz1fn); % Espectro de la grabacion 1 
title ('Espectro de la grabacion 1')

subplot(3,5,3),plot(g); %relacion de posicion de la grafica%
title ('Grabacion 2')
subplot(3,5,4),plot(voz2fn); % espectro de la grabacion 2 
title ('Espectro de la grabacion 2')

 subplot(3,5,6),plot(vozcfn); % espectro de la grabacion c 
 title ('Grabacion A Masculina')
 subplot(3,5,7),plot(vozpfn); % espectro de la grabacion p 
 title ('Grabacion E Masculina')
 subplot(3,5,8),plot(vozlfn); % espectro de la grabacion l 
 title ('Grabacion I Masculina')
 subplot(3,5,9),plot(vozafn); % espectro de la grabacion a 
 title ('Grabacion O Masculina')
 subplot(3,5,10),plot(voznfn); % espectro de la grabacion n 
 title ('Grabacion U Masculina')
 subplot(3,5,11),plot(vozwfn); % espectro de la grabacion w 
 title ('Grabacion A Femenina')
 subplot(3,5,12),plot(voztfn); % espectro de la grabacion t 
 title ('Grabacion E Femenina')
 subplot(3,5,13),plot(vozyfn); % espectro de la grabacion y 
 title ('Grabacion I Femenina')
 subplot(3,5,14),plot(vozkfn); % espectro de la grabacion k 
 title ('Grabacion O Femenina')
 subplot(3,5,15),plot(vozffn); % espectro de la grabacion f 
